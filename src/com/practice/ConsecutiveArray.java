...
public class ConsecutiveArray {
    ...
    // optimal approach
    public int areConsecutive(int[] A) {
    ...
    public static void main(String[] args) {
        ConsecutiveArray obConsecutive = new ConsecutiveArray();
        ...
        int[] A = {1, 3, 2, 5};
        // System.out.println("Result " + obConsecutive.solve(A));
        System.out.println("Result " + obConsecutive.areConsecutive(A));
